...
function preload() {
  ...
  for (i=0; i<4; i++) {
    imgsExplosao[i] = loadImage("explosion"+i+".jpg");
  }
}
...
function jogo(){
	...
	if(dist(xplayer+mtam,yplayer+mtam,xbul+mtam,ybul+mtam)<tam){
		mortos=mortos+1;
	...
	//DERROTA
	if(((nivel==1)&&(mortos>250))||((nivel==2)&&(mortos>2000))||((nivel==3)&&(mortos>1500))||((nivel==4)&&(mortos>1000))||((nivel==5)&&(mortos>500))){
		tela=3;
	}
...
/*function animacao(){
	anima = imgsExplosao[contFrame];
	if(!explodiu){
		if(((nivel==1)&&(mortos>250))||((nivel==2)&&(mortos>2000))||((nivel==3)&&(mortos>1500))||((nivel==4)&&(mortos>1000))||((nivel==5)&&(mortos>500))){
			image(anima, xplayer+mtam-((25+10*contFrame)/2), yplayer+mtam-((25+10*contFrame)/2));
		}
	}
	contFrame++;
	if (contFrame>3) {
