...
var tproj=20;
var mtproj=tproj/2;
var xproji=xusa+tam-tproj;
var xproj=xusa+tam-tproj;
var yproj=yusa+mtam-mtproj;
var vproj=20;
...
function jogo(){
	...
	if(dist(xusa+mtam,yusa+mtam,xgbr+mtam,ygbr+mtam)<tam){
		mortos=mortos-1;	
	}
...
function tiro(){
	...
	if((xproj+mtproj<0)||(xproj>800)){
		xproj=xusa+tam-tproj;
		yproj=yusa+mtam-mtproj;
		false;
	}
}
