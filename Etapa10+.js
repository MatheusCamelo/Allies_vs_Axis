...
function preload() {
  ...
  for (i=0; i<4; i++) {
    imgsFireball[i] = loadImage("fireball"+i+".png");
  }
}
...
function animacao(){
	anima = imgsFireball[contFrameAnima];
	if(atirou){ 
		image(anima, xproj, yproj);
	}
...
function texto2(){
	...
	textSize(40);
	fill(255); 
	text("PREPARE-SE", 290, 185);
	text("A GUERRA VAI COMEÇAR!", 175, 250);
	textSize(250);
	text(4-Math.floor(contFrame/30), 330, 500);
}
...
function texto4(){
	...
	textSize(50);
	fill(255); 
	text("FIM DE JOGO", 260, 185);
	textSize(30);
	text("VOCÊ ULTRAPASSOU O MÁXIMO DE BAIXAS", 140, 250);
	textSize(30);
	text("VOCÊ FEZ "+pts+" PONTOS", 270, 375);
	textSize(30);
	text("TECLE F5 PARA RETORNAR À TELA INICIAL", 140, 500);
}
...
function texto5(){
	...
	textSize(50);
	fill(255); 
	text("FIM DE JOGO!", 245, 185);
	textSize(30);
	text("VOCÊ VENCEU A GUERRA!", 225, 250);
	textSize(30);
	text("TECLE F5 PARA RETORNAR À TELA INICIAL", 125, 400);
}
